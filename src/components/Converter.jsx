  ...
  return (
    <section className="bg-neutral-900 flex flex-col ">
      ...
      >
        ...
        >
          <p aria-live="polite" className="flex items-center text-xs lg:w-full">
          ...
          <div className="flex justify-center items-center gap-2 my-2">
            <button
              ...
              aria-label={
                favorite
                  ? `Remove ${from} to ${to} from favorites`
                  : `Add ${from} to ${to} to favorites`
              }
            ...
            <button
              ...
              aria-label={`Log conversion from ${from} to ${to}`}
